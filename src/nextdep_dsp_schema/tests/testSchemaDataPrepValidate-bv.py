...
class SchemaDataPrepValidateTests(unittest.TestCase):
    ...
    def testValidateOptsList(self):
        ...
        if not inputPathList:
            return True
        #databaseNameD = {"pdbx_core": ["pdbx_core_polymer_entity", "pdbx_core_entry", "pdbx_core_polymer_entity_instance", "pdbx_core_entity_instance_validation"]}
        databaseNameD = {"pdbx_core": ["pdbx_core_polymer_entity", "pdbx_core_entry", "pdbx_core_polymer_entity_instance"]}

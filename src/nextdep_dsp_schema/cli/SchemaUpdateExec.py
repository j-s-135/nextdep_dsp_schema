...
from ..define.SchemaDefAccess import SchemaDefAccess
from ..utils.SchemaProvider import SchemaProvider
...
def main():
    ...
    #
    parser.add_argument("--update_pdbx_mmcif", default=False, action="store_true", help="Update schema for PDBx/mmCIF")
    #
    #
    ...
    try:
        if os.access(configPath, os.R_OK):
            ...
            exit(1)
        mockTopPath = os.path.join(TOPDIR, "wwpdb", "mock-data") if args.mock else None
    ...
    #
    databaseNameList = []
    if args.update_pdbx_mmcif:
        databaseNameList.append("pdbx_mmcif")
